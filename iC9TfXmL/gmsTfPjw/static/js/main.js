...
var siteid = 1274627109;//CNZZ统计ID
var stxlwx = stxlwx || '';
var stxlwxs = stxlwx || '';
...
$(function(){
    $('.weixinbox').each(function(index,el){
        $(el).append('<span class="weixin" oncopy="copy(\'长按复制\')">'+stxlwxs+'</span>');
    });

    
    var str = '<div class="buttomess">';
    str += '<div class="_buttomess">';
    str += '    <table>';
    str += '        <tr>';
    str += '            <td width="50px" valign="middle">';
    str += '                <img src="static/images/click.png" width="50px" alt="">';
    str += '            </td>';
    str += '            <td valign="middle">';
    str += '                <span>添加客服微信号微信：<span class="weixin" oncopy="copy(\'长按复制\')">'+stxlwxs+'</span>(长按复制微信号) </span>';
    str += '                <a onclick="gotoWechat(\'去微信\')">去微信>></a>';
    str += '            </td>';
    str += '        </tr>';
    str += '    </table>';
    str += '</div>';
