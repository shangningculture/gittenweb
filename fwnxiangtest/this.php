...
class TokenUtil {
    ...
    public static function build_access_token(){
        ...
        curl_setopt($ch, CURLOPT_URL, "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx78a31e67ff766dd6&secret=eb1075284e21257a3970a5392b8b4fa2");//设置你所需要抓取的URL
