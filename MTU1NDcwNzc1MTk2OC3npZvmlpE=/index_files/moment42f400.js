...
});define("a/mpAdAsync.js",["appmsg/log.js","biz_wap/utils/ajax.js","rt/appmsg/getappmsgext.rt.js","a/a.js","a/a_utils.js","biz_common/utils/url/parse.js","a/a_config.js"],function(e){
"use strict";
function i(e,i,p){
var _=[],g=o.checkNeedAds(),w=g.is_need_ad,l=g.both_ad,A=m.getQuery("mock"),f=m.getQuery("rtx"),v="/mockserver/mockservercgi-bin/offerTestCase/mmbizwap/mp/getappmsgad",y="/mp/getappmsgad";
i=i||{},e=e||[];
for(var u=0;u<e.length;u++)0===e[u].indexOf(c.ORIGIN_VIDEO_VID_PREFIX)&&_.push(e[u]);
(A&&"-1"!=A||f)&&(console.info("[广告走mock系统] mockId",A,"rtx",f),y=v),console.info("[广告发送请求] 是否拉取广告",w),
d({
...
o.afterGetAdData(g,e),r.setBackgroundClass();
var i=e;
if(i.advertisement_info&&0!=i.advertisement_info.length)try{
if(s("[Appmsg] success get async ad data, async data is: "+JSON.stringify(i)),window.originalVideoAdFramesAdData={},
i.advertisement_info)for(var d=0;d<i.advertisement_info.length;d++){
i.advertisement_info[d].cdg_appid=i.appid;
var n=i.advertisement_info[d].vid;
n&&"string"==typeof n&&1===i.advertisement_info[d].is_mp_video&&(window.originalVideoAdFramesAdData[n]=r.saveCopy(i.advertisement_info[d]));
}
a(_,window.originalVideoAdFramesAdData[_[0]]);
}catch(m){}else s("[Appmsg] success get async ad data, async data is empty"),a(_);
p&&p(),t();
},
error:function(){
s("[Appmsg] error get async ad data, biz="+biz+", mid="+mid),a(_),t();
}
});
}
function a(e,i){
var i,a=document.getElementsByTagName("iframe");
if(window.originalVideoAdFramesAdData=window.originalVideoAdFramesAdData||{},window.originalVideoAdFramesUnsetList)for(var t=0;t<window.originalVideoAdFramesUnsetList.length;t++)for(var s=0;s<a.length;s++)if(a[s].dataset&&a[s].dataset.mpvid==window.originalVideoAdFramesUnsetList[t]){
window.originalVideoAdFramesAdData[a[s].dataset.mpvid]||(window.originalVideoAdFramesAdData[a[s].dataset.mpvid]={}),
i=window.originalVideoAdFramesAdData[a[s].dataset.mpvid],a[s].contentWindow.postMessage({
...
r.broadcastFrame(e,c.APPMSGAD_READY_ACTION,""),r.listenMessage(window,function(e,i){
i.action===c.GET_APPMSGAD_READY_STATUS_ACTION&&r.postMessage(e.source,c.APPMSGAD_READY_ACTION,"");
});
}
var s=e("appmsg/log.js"),d=e("biz_wap/utils/ajax.js"),n=e("rt/appmsg/getappmsgext.rt.js"),o=e("a/a.js"),r=e("a/a_utils.js"),m=e("biz_common/utils/url/parse.js"),c=e("a/a_config.js");
return{
getAdData:i
};
