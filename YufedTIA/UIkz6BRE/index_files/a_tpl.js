...
function a(t){
function e(){
if(j.mutexCount==r&&(r=0,j.mutexCount=0,"function"==typeof n)){
var t=0;
...
var o=t.cur,i=t.stopCur===!0?!0:!1,n=t.callback,r=0;
for(var s in j.mutexPlayers)for(var u=0,p=j.mutexPlayers[s].length;p>u;u++)r++;
for(var s in j.mutexPlayers)for(var u=0,p=j.mutexPlayers[s].length;p>u;u++){
var _=j.mutexPlayers[s][u];
if(_&&_!==o){
...
var r=t.state;
"ended"==r&&(r="stop"),"wait"==r&&(r="waiting");
var s=!1;
if("error"==r)for(var u in i._g.stateChangeCallback)i._g.stateChangeCallback.hasOwnProperty(u)&&"function"==typeof i._g.stateChangeCallback[u]&&(s=!0,
i._g.stateChangeCallback[u](-1,t.errMsg||""),i._g.stateChangeCallback[u]=null);else"function"==typeof i._g.stateChangeCallback[r]&&(j.debug&&console.log("excute stateChangeCallback :"+r),
s=!0,i._g.stateChangeCallback[r](0),i._g.stateChangeCallback[r]=null);
s||"function"!=typeof j.jsapiGlobalEvent[r]||j.jsapiGlobalEvent[r](t,i);
}
}
}
});
...
var o="acc_ing_error;type:#type#;uin:"+(top.window.user_uin||"")+";playurl:"+e._o.jsapi2Src+";pageurl:"+top.location.href;
...
function f(){
for(var t=j.reportId.split(";"),e=0,o=t.length;o>e;e++)for(var i=t[e],a=j.keyConf[e],n=0,r=0,s=a.length;s>r;r++){
var u=a[r]||"";
...
}),v(i.type,"pv",1),v(i.type,"wx_pv",1),v(i.type,"wx_pv_2",1),i.jsapi2Src&&i.jsapi2Src!=i.src&&v(-1,"aac_pv",1);
var e=o.jsApiData;
...
var i="acc_start_error;type:#type#;uin:"+(top.window.user_uin||"")+";playurl:"+e.jsapi2Src+";pageurl:"+top.location.href;
j.isAndroid?(A.logReport("",i.replace("#type#","android"),"ajax"),v(-1,"android_aac_err_1",1)):(A.logReport("",i.replace("#type#","ios"),"ajax"),
v(-1,"ios_aac_err_1",1));
}
}
});
...
function e(){
n.seeking=!1,o._onPlay(),n.starTime=+new Date-1e3*r,o._analogUpdateTime(),o._getMusicPlayerState();
}
var o=this,i=this._g,a=this._o,n=this.jsApiData,r=parseInt(t,10);
r>=this._o.duration&&(r=this._o.duration-1),n.getStatusId&&clearTimeout(n.getStatusId),
...
position:r,
onError:function(){
if(v(a.type,"seek_err",1),a.jsapi2Src&&a.jsapi2Src!=a.src){
var t="acc_seek_error;type:#type#;uin:"+(top.window.user_uin||"")+";playurl:"+a.jsapi2Src+";pageurl:"+top.location.href;
j.isAndroid?(A.logReport("",t.replace("#type#","android"),"img"),v(-1,"android_aac_err_3",1)):(A.logReport("",t.replace("#type#","ios"),"img"),
v(-1,"ios_aac_err_3",1));
}
!!j.debug&&console.log("seek callback fail"),n.seeking=!1,o._analogUpdateTime(),
...
!!j.debug&&console.log("seeked to play"),s&&clearTimeout(s),e();
}):"seeked"==t&&(!!j.debug&&console.log("seeked callback success"),(2==o._status||4==o._status)&&(s=setTimeout(function(){
...
for(var r=j.mutexPlayers2[t.jsapi2Src],i=0,a=r.length;a>i;i++)if(r[i]===this){
r.splice(i,1);
break;
}
if(0==r.length)try{
...
z.url_scheme&&j.gtVersion("6.5.6",!0)?b.invoke("launchApplication",{
schemeUrl:z.url_scheme
},function(a){
