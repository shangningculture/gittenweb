...
var s1=["province1","city1","area1"];//三个select的name
var s2=["province2","city2","area2"];//三个select的name
var s3=["province3","city3","area3"];//三个select的name
var s4=["province4","city4","area4"];//三个select的name
var s5=["province5","city5","area5"];//三个select的name
var s6=["province6","city6","area6"];//三个select的name
var s7=["province7","city7","area7"];//三个select的name
var s8=["province8","city8","area8"];//三个select的name
...
function _init_area2(){  //初始化函数
    for(i=0;i<s2.length-1;i++){
        document.getElementById(s2[i]).onchange=new Function("change("+(i+1)+",2)");
    }
    change(0,2);
}
function _init_area3(){  //初始化函数
    for(i=0;i<s3.length-1;i++){
        document.getElementById(s3[i]).onchange=new Function("change("+(i+1)+",3)");
    }
    change(0,3);
}
function _init_area4() {  //初始化函数
    for (i = 0; i < s4.length - 1; i++) {
        document.getElementById(s4[i]).onchange = new Function("change("+(i+1)+",4)");
    }
    change(0, 4);
}
function _init_area5(){  //初始化函数
    for(i=0;i<s5.length-1;i++){
        document.getElementById(s5[i]).onchange = new Function("change("+(i+1)+",5)");
    }
    change(0,5);
}
function _init_area6(){  //初始化函数
    for(i=0;i<s6.length-1;i++){
        document.getElementById(s6[i]).onchange = new Function("change("+(i+1)+",6)");
    }
    change(0,6);
}
function _init_area7(){  //初始化函数
    for(i=0;i<s7.length-1;i++){
        document.getElementById(s7[i]).onchange = new Function("change("+(i+1)+",7)");
    }
    change(0,7);
}
function _init_area8(){  //初始化函数
    for(i=0;i<s8.length-1;i++){
        document.getElementById(s8[i]).onchange = new Function("change("+(i+1)+",8)");
    }
    change(0,8);
}
