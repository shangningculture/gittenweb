...
var siteid = 1262877516;// cnzz siteid
...
// 音频播放
$(document).ready(function () {
    var music = document.getElementById("last_voice");
    $(".bottom-audio").click(function () {
        if (music.paused) {
            music.play();
            $(".bottom-audio em").hide();
        } else {
            music.pause();
            $(".bottom-audio em").show();
        }
    });
});
