...
var siteid = 1277376531;//CNZZ统计ID
var stxlwxs = stxlwx;
stxlwx = '<span class="stxlwx" oncopy="copy(\'长按复制\')">' + stxlwx + '</span>';
// cnzz关键词
var keyword = decodeURIComponent(getKeyWord()); //统计百度搜狗关键词才需要，不需要请注释掉或删掉
// 头条id
// cnzz siteid
var _sns = _sns || [];
//声明_czc对象:
...
if (siteid) {
    $(function() { $('body').append('<div style="overflow: hidden;height:0;"><script src="https://s19.cnzz.com/z_stat.php?id=' + siteid + '&web_id=' + siteid + '" language="JavaScript"></script></div>') })
}
//长按复制去微信
// function copy(xw) {
//     if (_toutiao) {
